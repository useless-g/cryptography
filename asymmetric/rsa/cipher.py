...
if __name__ == "__main__":
    ...
    Alice = RSA(cipher_key="public",
                key=((, ), (, ))
    ...
    # private random key < 256 don't work
    # public random key == 256 don't work same deciphered? but with long trash in the end
    # public random key > 256 long trash
